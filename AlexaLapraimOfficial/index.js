...
// Responds when no utternaces are present : e.g. "Open Lapraim Digital" //
"LaunchRequest": function() {
    this.response.speak("Welcome to LaPraim Digital. What can I help you with?").listen("What can I help you with?");
...
"userListOfProjects": function() {
  ...
  axios({
    method: 'get',
    url:"https://lapraimdigitalagency.teamwork.com/projects.json?status=ACTIVE",
    headers: {
...
"overdueProjectIntent": function() {
  ...
  axios({
    method: 'get',
    url:"https://lapraimdigitalagency.teamwork.com/tasks.json?filter=overdue",
    headers: {
            'Content-Type' : 'application/json',
            'Accept' : 'application/json',
            'Authorization' : "Bearer " + token
...
"completedTasksIntent": function() {
    ...
    axios({
      method: 'get',
      url:"https://lapraimdigitalagency.teamwork.com/completedtasks.json?startdate="+yesterday+"&enddate="+today,
      headers: {
              'Content-Type' : 'application/json',
              'Accept' : 'application/json',
              'Authorization' : "Bearer " + token
  ...
  'projectStatusIntent': function() {
    ...
    axios({
      ...
      if (!response) {
        ...
        axios({
          method: "get",
          url:
            "https://lapraimdigitalagency.teamwork.com/projects/" +
            projectId +
            "/tasks.json",
          ...
          if (response.data["todo-items"].length === 0) {
            ...
            if(error.response.status) {
              this.response.speak("This project does not exist.");
              this.emit(":responseReady")
            }
          })
        })
    ...
    "createProjectIntent": function() {
      ...
      axios({
        method: "post",
        url: "https://lapraimdigitalagency.teamwork.com/projects.json",
        headers: {
          "Content-Type": "application/json",
          "Accept": "application/json",
          'Authorization' : "Bearer " + token
        ...
        this.response.speak("An error occured while creating the project." + errorMessage);
        this.emit(":responseReady")
      });
    },
      ...
      axios({
        ...
        .then(projectId => {
          axios({
            method: "delete",
            url:
              "https://lapraimdigitalagency.teamwork.com/projects/" + projectId + ".json",
